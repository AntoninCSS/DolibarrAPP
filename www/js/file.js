function encodeImageFileAsURL(element) {
  // Crée la function avec comme argument un Fichier ici
  ...
  reader.onloadend = function () {
    // permet de lire levement "onchange" dans le html et execute ce
...
async function post_file() {
  ...
  if (data.ok) {
    ...
    console.log("Done");
    //redirection après que la photo/document a ete uploader et que la note de frais avec toute les info aussi
...
function cameraApp() {
  navigator.camera.getPicture(onSucess, onFail, {
    //syntaxe ppour prendre la photo en natif
    //option de la photo :
    quality: 100,
