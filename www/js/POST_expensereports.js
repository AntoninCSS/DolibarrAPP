...
//     }
    ...
    async function createNDF(){
      ...
      const data = await fetch(url,{
            ...
            body:  JSON.stringify({
                "lines": [{
                "qty":"1",              //quantité produits bloquer a 1 produits 
                "date": "2023-03-17",   // ajout date picker
                "fk_c_type_fees": "2",  //Type de frais 1-4 
                "value_unit": "80",      //Prix unité
                "total_ttc": "100"      // Total de la ligne qui serait le meme que el value unit
            }],
                "date_debut":  `${Date_Debut/1000}`,
                "date_fin":    `${Date_Fin/1000}`,
                "fk_user_author": `${U_ID}`,
